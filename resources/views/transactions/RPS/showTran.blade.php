...
@section('content')
    <div style="margin-top: -20px" class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
            <div><a href="{{ url('/RPStransactions')}}"><- Back to Transactions list</a></div>
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4">
                                    <label class="pull-right" style="font-weight: 700" for="ID">Address: </label>
                                </div>
                                <div class="col-sm-4">
                                            ...
                                            <div class="modal-content">
                                                <div style="background:#008B8B; color: white" class="modal-header"></div>
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="{{ url('RPSedit_transactions/'.$transactionShow->id) }}" >
                                                            @csrf
                                                            <div style="margin-left: 45%">
