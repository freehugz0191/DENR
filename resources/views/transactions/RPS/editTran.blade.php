    ...
    <div class="col-md-14">
        ...
        <div class="card-header">Edit Transaction Number: {{$transaction->id}}</div>
            <div class="card-body">
                ...
                <form action="{{ url('RPSupdate_transactions/'.$transaction->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="permit_ID">Transaction ID</label>
                    ...
                    <div style="align-items: baseline" class="modal-footer">
                        ...
                        <a href="{{ url('transactions/RPS/transaction') }}" type="button" class="btn btn-round btn-secondary pull-right">Back</a>
                    </div>
                </form>
            </div>
        </div>
