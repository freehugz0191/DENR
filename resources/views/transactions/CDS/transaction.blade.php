...
@section('content')
<div  class="container">
    <h3 style="text-align: center">CDS Transactions</h3>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="row" style="margin-top: 10px">
                    ...
                    <input style="font-size: 15px; padding-left: 8px; height: 31px; margin-right: 3px" class="col-3" id="cds_search" type="text">
                </div>
                <div style="font-weight: 700" class="card-header">Manage Conservation and Development Section (CDS) Transactions</div>
                    <table id="cds_table" class="table table-striped">
                            ...
                            @foreach ($transaction as $item)
                                <tr style="font-size: 12px">
                                    ...
                                    <td style="width: 100px">
                                        ...
                                        <a style="margin-bottom: 3px" href="{{ url('CDSshow_transactions/'.$item->id) }}" type="button" class="btn btn-outline-info btn-sm" title="show" rel="tooltip" >
                                            <i class="fa fa-eye"></i>
                                        </a>&nbsp;
                                        
                                        <a style="margin-bottom: 3px" href="{{ url('CDSedit_transactions/'.$item->id) }}" type="button" class="btn btn-outline-success btn-sm" title="edit" rel="tooltip" >
                                        ...
                                        <button class="btn btn-outline-danger btn-sm remove-tran" data-id="{{ $item->id }}" data-action="{{ url('CDSdelete_transactions/'.$item->id) }}"> <i class="fa fa-trash"></i></button>
...
<script>
    $(document).ready(function(){
      $('#cds_search').keyup(function(){
        search_table($(this).val());
      });

      function search_table(value){
        $('#cds_table tr').each(function(){
          var found = 'false';
          $(this).each(function(){
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form action="/CDSadd_transactions" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select style="height: 35px;" name="applicant_id" id="applicant_id" class="form-control" required>
